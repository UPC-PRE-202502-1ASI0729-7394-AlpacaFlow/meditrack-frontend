...
/**
 * Defines a contract for assembler classes that convert between model, resources, and API responses.
...
TResource extends BaseResource, TResponse extends BaseResponse> {
  ...
  /**
   * Converts an API response to an array of entituies
   * @param response - The API response containing model
